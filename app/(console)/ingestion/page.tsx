  ...
  return (
    <div style={{ padding: 14, display: 'flex', flexDirection: 'column', gap: 14, maxWidth: 1240, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.05fr) minmax(0, .95fr)', gap: 14, alignItems: 'start' }}>
        <section>
          <SectionLabel right={<LinkChip href="/engine">Run history</LinkChip>}>Run pipeline jobs</SectionLabel>
          <RunPanel clients={data.clients} />
        </section>

        <section>
          <SectionLabel right={<LinkChip href="/ingestion/3pl">3PL staging</LinkChip>}>Stage a file</SectionLabel>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: 14, alignItems: 'start' }}>
        <section>
          <SectionLabel right={<LinkChip href="/ingestion/3pl">Open 3PL</LinkChip>}>3PL cycles</SectionLabel>
          <TableShell>
            <table className="tbl">
              <thead>
                <tr>
...
function QuickLinks() {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 10 }}>
      <QuickLink href="/ingestion/exceptions" label="Map exceptions" detail="Review unknown accessorial and service codes" />
      <QuickLink href="/ingestion/3pl" label="Review 3PL" detail="Cycle summaries, line matches, storage intake" />
      <QuickLink href="/queue" label="Review findings" detail="Approve, dismiss, or file disputes" />
      <QuickLink href="/rulebook" label="Audit contract rules" detail="Contract, carrier, and global precedence" />
    </div>
  );
}
